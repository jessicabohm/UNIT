...
"""
from networks_3d import AdaINGen, MsImageDis, VAEGen
...
class UNIT_Trainer(nn.Module):
    ...
    def gen_update(self, x_a, x_b, hyperparameters):
        ...
        # decode (within domain) [decode to have 4 channels of output (0,1,2,3)]
    ...
    def sample(self, x_a, x_b):
        ...
        x_a_recon = torch.argmax(x_a_recon, dim=1, keepdim=True)
        x_ab = torch.argmax(x_ab, dim=1, keepdim=True)
        x_b_recon = torch.argmax(x_b_recon, dim=1, keepdim=True)
